      ...
      <div className="bg-white rounded-3xl shadow-2xl border-4 border-purple-300 overflow-hidden">
        ...
        <div className="p-5 sm:p-8">
          ...
          {plan.nutritional_interventions && Object.keys(plan.nutritional_interventions).length > 0 && (
            <div className="mt-6 sm:mt-8 bg-amber-50 border-2 border-amber-200 rounded-2xl p-5 sm:p-6">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden">
                    <table className="w-full">
                      <thead className="bg-amber-100">
                        <tr>
                          <th className="text-left px-4 py-2 text-xs sm:text-sm font-semibold text-amber-900">Side Effect</th>
                          <th className="text-left px-4 py-2 text-xs sm:text-sm font-semibold text-amber-900">Strategy</th>
                        </tr>
                      </thead>
                        ...
                        {Object.entries(plan.nutritional_interventions).map(([key, value]) => (
                          value && (
                            <tr key={key} className="hover:bg-amber-50">
                              <td className="px-4 py-3 text-xs sm:text-sm font-medium text-amber-900">{key}</td>
                              <td className="px-4 py-3 text-xs sm:text-sm text-amber-800">{value}</td>
                            </tr>
                          )
                        ))}
                      </tbody>
          ...
          {plan.immobilization_device && (
            <div className="mt-6 sm:mt-8 bg-indigo-50 border-2 border-indigo-200 rounded-2xl p-5 sm:p-6">
